...
Сценарий: экспорт документов продаж
	...
	И я проверяю или создаю для справочника "RowIDs" объекты:
		...
		| 'e1cib/data/Catalog.RowIDs?ref=933d60dd8ed5021d11ee29fd217660e7' | 'False'        | 24     | 'd71717c4-0905-4be1-89b7-70d05e2dfdf9' | 'e1cib/data/Catalog.Agreements?ref=b762b13668d0905011eb767f10805e2b' | 'e1cib/data/Catalog.Companies?ref=b762b13668d0905011eb7663e35d7964' | 'e1cib/data/Catalog.Currencies?ref=b762b13668d0905011eb7663e35d795e' | 'e1cib/data/Catalog.Companies?ref=b762b13668d0905011eb767f10805e29' | 'e1cib/data/Catalog.Partners?ref=b762b13668d0905011eb7663e35d7954' | 'True'                 | 'e1cib/data/Catalog.Stores?ref=b762b13668d0905011eb76684b9f6862' | 'e1cib/data/Catalog.Units?ref=b762b13668d0905011eb76684b9f687b' | 'e1cib/data/Catalog.ItemKeys?ref=b762b13668d0905011eb766bf96b2751' | ''       | 'e1cib/data/Document.SalesOrder?ref=933d60dd8ed5021d11ee29fd217660e3' | 'd71717c4-0905-4be1-89b7-70d05e2dfdf9' | 'Enum.ProcurementMethods.Stock' | ''            | ''              | 'Enum.ShipmentConfirmationTransactionTypes.Sales' | 'Enum.GoodsReceiptTransactionTypes.ReturnFromCustomer' | ''                | ''          | ''                   | ''                 | ''                   | 'False'                    | ''                  |
	...
	И я проверяю или создаю для справочника "Stores" объекты:
		...
		| 'e1cib/data/Catalog.Stores?ref=b762b13668d0905011eb76684b9f6862' | 'False'        | 2      | 'True'            | 'True'                    | 'False'   | 'False'                | 'Склад 2 (без контроля остатка)' | ''                 | ''               | ''               |
	...
	И я проверяю или создаю для документа "SalesInvoice" объекты:
		...
		| 'e1cib/data/Document.SalesInvoice?ref=933d60dd8ed5021d11ee29fd217660e8' | 'False'        | 1        | '{Строка(ТекущаяДата())}' | 'True'   | 'e1cib/data/Catalog.Agreements?ref=b762b13668d0905011eb767f10805e2b' | ''              | 'e1cib/data/Catalog.Companies?ref=b762b13668d0905011eb7663e35d7964' | 'e1cib/data/Catalog.Currencies?ref=b762b13668d0905011eb7663e35d795e' | '01.01.0001 0:00:00' | 'e1cib/data/Catalog.Companies?ref=b762b13668d0905011eb767f10805e29' | ''        | ''               | 'e1cib/data/Catalog.Partners?ref=b762b13668d0905011eb7663e35d7954' | 'True'            | 'False'          | ''                  | 'e1cib/data/Catalog.Users?ref=aa7f120ed92fbced11eb13d7279770c0' | ''       | ''            | 4900             |
	...
	И я перезаполняю для объекта табличную часть "ItemList":
		...
		| 'e1cib/data/Document.SalesInvoice?ref=933d60dd8ed5021d11ee29fd217660e8' | 4900          | 4083.33     | 'e1cib/data/Catalog.ItemKeys?ref=b762b13668d0905011eb766bf96b2751' | 'e1cib/data/Catalog.Stores?ref=b762b13668d0905011eb76684b9f6862' |                | 490     | 10         | 816.67      | '54b399dc-5936-46af-9969-0a78c26c39d4' | 'e1cib/data/Catalog.Units?ref=b762b13668d0905011eb76684b9f687b' | 'e1cib/data/Catalog.PriceTypes?ref=b762b13668d0905011eb767f10805e2a' | 'e1cib/data/Document.SalesOrder?ref=933d60dd8ed5021d11ee29fd217660e3' | '01.01.0001 0:00:00' | ''       | ''                 | ''            | ''                   | 'False'            | 10                   | 'True'                    |
	...
	И я перезаполняю для объекта табличную часть "TaxList":
		...
		| 'e1cib/data/Document.SalesInvoice?ref=933d60dd8ed5021d11ee29fd217660e8' | '54b399dc-5936-46af-9969-0a78c26c39d4' | 'e1cib/data/Catalog.Taxes?ref=b762b13668d0905011eb7663e35d7970' | ''          | 'e1cib/data/Catalog.TaxRates?ref=b762b13668d0905011eb7663e35d796c' | 816.67   | 'True'                 | 816.67         |

	И я перезаполняю для объекта табличную часть "Currencies":
		| 'Ref'                                                                   | 'Key' | 'CurrencyFrom'                                                       | 'Rate' | 'ReverseRate' | 'ShowReverseRate' | 'Multiplicity' | 'MovementType'                                                                                    | 'Amount' | 'IsFixed' |
		| 'e1cib/data/Document.SalesInvoice?ref=933d60dd8ed5021d11ee29fd217660e8' | ''    | 'e1cib/data/Catalog.Currencies?ref=b762b13668d0905011eb7663e35d795e' | 1      | 1             | 'False'           | 1              | 'e1cib/data/ChartOfCharacteristicTypes.CurrencyMovementType?ref=b762b13668d0905011eb7663e35d796b' | 4900     | 'False'   |
		| 'e1cib/data/Document.SalesInvoice?ref=933d60dd8ed5021d11ee29fd217660e8' | ''    | 'e1cib/data/Catalog.Currencies?ref=b762b13668d0905011eb7663e35d795e' | 0.859  | 1.1641        | 'False'           | 1              | 'e1cib/data/ChartOfCharacteristicTypes.CurrencyMovementType?ref=b762b13668d0905011eb7663e35d796a' | 4209.1   | 'False'   |
		| 'e1cib/data/Document.SalesInvoice?ref=933d60dd8ed5021d11ee29fd217660e8' | ''    | 'e1cib/data/Catalog.Currencies?ref=b762b13668d0905011eb7663e35d795e' | 1      | 1             | 'False'           | 1              | 'e1cib/data/ChartOfCharacteristicTypes.CurrencyMovementType?ref=b762b13668d0905011eb7663e35d7968' | 4900     | 'False'   |
		| 'e1cib/data/Document.SalesInvoice?ref=933d60dd8ed5021d11ee29fd217660e8' | ''    | 'e1cib/data/Catalog.Currencies?ref=b762b13668d0905011eb7663e35d795e' |        |               | 'False'           |                | 'e1cib/data/ChartOfCharacteristicTypes.CurrencyMovementType?ref=b762b13668d0905011eb7663e35d7969' |          | 'False'   |

	И я перезаполняю для объекта табличную часть "RowIDInfo":
		| 'Ref'                                                                   | 'Key'                                  | 'RowID'                                | 'Quantity' | 'Basis'                                                               | 'CurrentStep'                                    | 'NextStep'                                    | 'RowRef'                                                         | 'BasisKey'                             |
		| 'e1cib/data/Document.SalesInvoice?ref=933d60dd8ed5021d11ee29fd217660e8' | '54b399dc-5936-46af-9969-0a78c26c39d4' | 'd71717c4-0905-4be1-89b7-70d05e2dfdf9' | 10         | 'e1cib/data/Document.SalesOrder?ref=933d60dd8ed5021d11ee29fd217660e3' | 'e1cib/data/Catalog.MovementRules?refName=SI_SC' | 'e1cib/data/Catalog.MovementRules?refName=SC' | 'e1cib/data/Catalog.RowIDs?ref=933d60dd8ed5021d11ee29fd217660e7' | 'd71717c4-0905-4be1-89b7-70d05e2dfdf9' |
	...
	И я проверяю или создаю для документа "SalesOrder" объекты:
		...
		| 'e1cib/data/Document.SalesOrder?ref=933d60dd8ed5021d11ee29fd217660e3' | 'False'        | 1        | '{Строка(ТекущаяДата())}' | 'True'   | 'e1cib/data/Catalog.Agreements?ref=b762b13668d0905011eb767f10805e2b' | 'e1cib/data/Catalog.Companies?ref=b762b13668d0905011eb7663e35d7964' | 'e1cib/data/Catalog.Currencies?ref=b762b13668d0905011eb7663e35d795e' | '01.01.0001 0:00:00' | 'e1cib/data/Catalog.Companies?ref=b762b13668d0905011eb767f10805e29' | ''               | 'e1cib/data/Catalog.Partners?ref=b762b13668d0905011eb7663e35d7954' | 'True'            | 'e1cib/data/Catalog.ObjectStatuses?ref=b762b13668d0905011eb766bf96b2789' | 'False'                      | 'e1cib/data/Catalog.Users?ref=aa7f120ed92fbced11eb13d7279770c0' | ''       | ''            | 4900             |
	...
	И я перезаполняю для объекта табличную часть "ItemList":
		...
		| 'e1cib/data/Document.SalesOrder?ref=933d60dd8ed5021d11ee29fd217660e3' | 'd71717c4-0905-4be1-89b7-70d05e2dfdf9' | 'False'  | 'e1cib/data/Catalog.ItemKeys?ref=b762b13668d0905011eb766bf96b2751' | 'e1cib/data/Catalog.Stores?ref=b762b13668d0905011eb76684b9f6862' | 4083.33     |                | 490     | 'e1cib/data/Catalog.PriceTypes?ref=b762b13668d0905011eb767f10805e2a' | 10         | 816.67      | 4900          | 'e1cib/data/Catalog.Units?ref=b762b13668d0905011eb76684b9f687b' | '01.01.0001 0:00:00' | 'Enum.ProcurementMethods.Stock' | ''       | ''                 | ''            | 'False'            | 10                   | ''             | ''            | '01.01.0001 0:00:00' |

	И я перезаполняю для объекта табличную часть "TaxList":
		| 'Ref'                                                                 | 'Key'                                  | 'Tax'                                                           | 'Analytics' | 'TaxRate'                                                          | 'Amount' | 'IncludeToTotalAmount' | 'ManualAmount' |
		| 'e1cib/data/Document.SalesOrder?ref=933d60dd8ed5021d11ee29fd217660e3' | 'd71717c4-0905-4be1-89b7-70d05e2dfdf9' | 'e1cib/data/Catalog.Taxes?ref=b762b13668d0905011eb7663e35d7970' | ''          | 'e1cib/data/Catalog.TaxRates?ref=b762b13668d0905011eb7663e35d796c' | 816.67   | 'True'                 | 816.67         |

	И я перезаполняю для объекта табличную часть "Currencies":
		| 'Ref'                                                                 | 'Key' | 'CurrencyFrom'                                                       | 'Rate' | 'ReverseRate' | 'ShowReverseRate' | 'Multiplicity' | 'MovementType'                                                                                    | 'Amount' | 'IsFixed' |
		| 'e1cib/data/Document.SalesOrder?ref=933d60dd8ed5021d11ee29fd217660e3' | ''    | 'e1cib/data/Catalog.Currencies?ref=b762b13668d0905011eb7663e35d795e' | 1      | 1             | 'False'           | 1              | 'e1cib/data/ChartOfCharacteristicTypes.CurrencyMovementType?ref=b762b13668d0905011eb7663e35d796b' | 4900     | 'False'   |
		| 'e1cib/data/Document.SalesOrder?ref=933d60dd8ed5021d11ee29fd217660e3' | ''    | 'e1cib/data/Catalog.Currencies?ref=b762b13668d0905011eb7663e35d795e' | 0.859  | 1.1641        | 'False'           | 1              | 'e1cib/data/ChartOfCharacteristicTypes.CurrencyMovementType?ref=b762b13668d0905011eb7663e35d796a' | 4209.1   | 'False'   |
		| 'e1cib/data/Document.SalesOrder?ref=933d60dd8ed5021d11ee29fd217660e3' | ''    | 'e1cib/data/Catalog.Currencies?ref=b762b13668d0905011eb7663e35d795e' | 1      | 1             | 'False'           | 1              | 'e1cib/data/ChartOfCharacteristicTypes.CurrencyMovementType?ref=b762b13668d0905011eb7663e35d7968' | 4900     | 'False'   |
		| 'e1cib/data/Document.SalesOrder?ref=933d60dd8ed5021d11ee29fd217660e3' | ''    | 'e1cib/data/Catalog.Currencies?ref=b762b13668d0905011eb7663e35d795e' |        |               | 'False'           |                | 'e1cib/data/ChartOfCharacteristicTypes.CurrencyMovementType?ref=b762b13668d0905011eb7663e35d7969' |          | 'False'   |

	И я перезаполняю для объекта табличную часть "RowIDInfo":
		| 'Ref'                                                                 | 'Key'                                  | 'RowID'                                | 'Quantity' | 'Basis' | 'CurrentStep' | 'NextStep'                                       | 'RowRef'                                                         | 'BasisKey' |
		| 'e1cib/data/Document.SalesOrder?ref=933d60dd8ed5021d11ee29fd217660e3' | 'd71717c4-0905-4be1-89b7-70d05e2dfdf9' | 'd71717c4-0905-4be1-89b7-70d05e2dfdf9' | 10         | ''      | ''            | 'e1cib/data/Catalog.MovementRules?refName=SI_SC' | 'e1cib/data/Catalog.RowIDs?ref=933d60dd8ed5021d11ee29fd217660e7' | ''         |
	...
	И я проверяю или создаю для документа "SalesReturn" объекты:
		...
		| 'e1cib/data/Document.SalesReturn?ref=933d60dd8ed5021d11ee29fd217660e9' | 'False'        | 1        | '{Строка(ТекущаяДата())}' | 'False'  | 'e1cib/data/Catalog.Agreements?ref=b762b13668d0905011eb767f10805e2b' | ''             | 'e1cib/data/Catalog.Companies?ref=b762b13668d0905011eb7663e35d7964' | 'e1cib/data/Catalog.Currencies?ref=b762b13668d0905011eb7663e35d795e' | '01.01.0001 0:00:00' | 'e1cib/data/Catalog.Companies?ref=b762b13668d0905011eb767f10805e29' | ''               | 'e1cib/data/Catalog.Partners?ref=b762b13668d0905011eb7663e35d7954' | 'True'            | 'False'        | ''                  | 'e1cib/data/Catalog.Users?ref=aa7f120ed92fbced11eb13d7279770c0' | ''       | ''            | 490              |
	...
	И я перезаполняю для объекта табличную часть "ItemList":
		...
		| 'e1cib/data/Document.SalesReturn?ref=933d60dd8ed5021d11ee29fd217660e9' | 'd79913ca-d032-43dd-9fad-e3230347f719' | 'False'  | 'e1cib/data/Catalog.ItemKeys?ref=b762b13668d0905011eb766bf96b2751' | 'e1cib/data/Catalog.Stores?ref=b762b13668d0905011eb76684b9f6862' | 408.33      |                | 490     | 'e1cib/data/Catalog.PriceTypes?ref=b762b13668d0905011eb767f10805e2a' | 1          | 81.67       | 490           | 'e1cib/data/Catalog.Units?ref=b762b13668d0905011eb76684b9f687b' | ''                 | 'e1cib/data/Document.SalesInvoice?ref=933d60dd8ed5021d11ee29fd217660e8' | 'False'            | 1                    | ''                 | ''            | ''                   | 'True'            | ''             |

	И я перезаполняю для объекта табличную часть "TaxList":
		| 'Ref'                                                                  | 'Key'                                  | 'Tax'                                                           | 'Amount' | 'Analytics' | 'TaxRate'                                                          | 'IncludeToTotalAmount' | 'ManualAmount' |
		| 'e1cib/data/Document.SalesReturn?ref=933d60dd8ed5021d11ee29fd217660e9' | 'd79913ca-d032-43dd-9fad-e3230347f719' | 'e1cib/data/Catalog.Taxes?ref=b762b13668d0905011eb7663e35d7970' | 81.67    | ''          | 'e1cib/data/Catalog.TaxRates?ref=b762b13668d0905011eb7663e35d796c' | 'True'                 | 81.67          |

	И я перезаполняю для объекта табличную часть "Currencies":
		| 'Ref'                                                                  | 'CurrencyFrom'                                                       | 'Rate' | 'ReverseRate' | 'ShowReverseRate' | 'Multiplicity' | 'Key' | 'MovementType'                                                                                    | 'Amount' | 'IsFixed' |
		| 'e1cib/data/Document.SalesReturn?ref=933d60dd8ed5021d11ee29fd217660e9' | 'e1cib/data/Catalog.Currencies?ref=b762b13668d0905011eb7663e35d795e' | 1      | 1             | 'False'           | 1              | ''    | 'e1cib/data/ChartOfCharacteristicTypes.CurrencyMovementType?ref=b762b13668d0905011eb7663e35d796b' | 490      | 'False'   |
		| 'e1cib/data/Document.SalesReturn?ref=933d60dd8ed5021d11ee29fd217660e9' | 'e1cib/data/Catalog.Currencies?ref=b762b13668d0905011eb7663e35d795e' | 0.859  | 1.1641        | 'False'           | 1              | ''    | 'e1cib/data/ChartOfCharacteristicTypes.CurrencyMovementType?ref=b762b13668d0905011eb7663e35d796a' | 420.91   | 'False'   |
		| 'e1cib/data/Document.SalesReturn?ref=933d60dd8ed5021d11ee29fd217660e9' | 'e1cib/data/Catalog.Currencies?ref=b762b13668d0905011eb7663e35d795e' | 1      | 1             | 'False'           | 1              | ''    | 'e1cib/data/ChartOfCharacteristicTypes.CurrencyMovementType?ref=b762b13668d0905011eb7663e35d7968' | 490      | 'False'   |
		| 'e1cib/data/Document.SalesReturn?ref=933d60dd8ed5021d11ee29fd217660e9' | 'e1cib/data/Catalog.Currencies?ref=b762b13668d0905011eb7663e35d795e' |        |               | 'False'           |                | ''    | 'e1cib/data/ChartOfCharacteristicTypes.CurrencyMovementType?ref=b762b13668d0905011eb7663e35d7969' |          | 'False'   |

	И я перезаполняю для объекта табличную часть "RowIDInfo":
		| 'Ref'                                                                  | 'Key'                                  | 'RowID'                                | 'Quantity' | 'Basis'                                                                 | 'CurrentStep'                                     | 'NextStep'                                    | 'RowRef'                                                         | 'BasisKey'                             |
		| 'e1cib/data/Document.SalesReturn?ref=933d60dd8ed5021d11ee29fd217660e9' | 'd79913ca-d032-43dd-9fad-e3230347f719' | 'd71717c4-0905-4be1-89b7-70d05e2dfdf9' | 1          | 'e1cib/data/Document.SalesInvoice?ref=933d60dd8ed5021d11ee29fd217660e8' | 'e1cib/data/Catalog.MovementRules?refName=SRO_SR' | 'e1cib/data/Catalog.MovementRules?refName=GR' | 'e1cib/data/Catalog.RowIDs?ref=933d60dd8ed5021d11ee29fd217660e7' | '54b399dc-5936-46af-9969-0a78c26c39d4' |
