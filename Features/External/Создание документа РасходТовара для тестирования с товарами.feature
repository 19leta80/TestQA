...
Функционал: Создание документа РасходТовара для тестирования с товарами

Сценарий: Создание документа РасходТовара для тестирования с товарами
...
// Справочник.Валюты
	...
	И я проверяю или создаю для документа "РасходТовара" объекты:
		...
		| 'e1cib/data/Документ.РасходТовара?ref=935b60dd8ed5021d11ee57067db6e99a' | 'False'           | '810      ' | '19.09.2023 19:23:04' | 'False'    | 'e1cib/data/Справочник.Контрагенты?ref=8ca0000d8843cd1b11dc8d043d71258d' | 'e1cib/data/Справочник.Склады?ref=8ca1000d8843cd1b11dc8eb49faea67b' | 'e1cib/data/Справочник.Валюты?ref=a9b000055d49b45e11db8c4421dda1c5' | 'e1cib/data/Справочник.ВидыЦен?ref=a9b000055d49b45e11db8c4c9d5c4224' | 'Ура! Наконецто все купили!!' | 'e1cib/data/Справочник.Организации?ref=8d34000d8843cd1b11dd2bea12f94c63' |

	И я перезаполняю для объекта табличную часть "Товары":
		| 'Ссылка'                                                                | 'Товар'                                                             | 'Цена' | 'Количество' | 'Сумма' |
		| 'e1cib/data/Документ.РасходТовара?ref=935b60dd8ed5021d11ee57067db6e99a' | 'e1cib/data/Справочник.Товары?ref=8ca2000d8843cd1b11dc910e5100d880' | 6500   | 1            | 6500    |
		| 'e1cib/data/Документ.РасходТовара?ref=935b60dd8ed5021d11ee57067db6e99a' | 'e1cib/data/Справочник.Товары?ref=8ca2000d8843cd1b11dc91039d7fd10b' | 8000   | 1            | 8000    |
